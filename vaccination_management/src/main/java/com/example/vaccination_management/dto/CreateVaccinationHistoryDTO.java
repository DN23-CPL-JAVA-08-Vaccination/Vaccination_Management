...
public class CreateVaccinationHistoryDTO {
    ...
    public CreateVaccinationHistoryDTO() {
    }

    public CreateVaccinationHistoryDTO( Vaccination vaccination, Patient patient, VaccinationStatus vaccinationStatus, String preStatus, double dosage, String startTime, String endTime, String guardianName, String guardianPhone, boolean deleteflag, int vaccinationTimes, int patientId, int vaccinationId, int employeeId, int vaccinationStatusId) {
